...
<form name="form1" method="post" action="<%=path %>/servlet/updateStaff">
    ...
    <div id="content">
        ...
        <table>
            <tr>
                <td>员工编号：</td>
                <td class="last2"><input name="sId" type="text" readonly="readonly"
                                         style="background-color:#c4eaf3; width:345px;" value="${sf.sId }"/></td>
            </tr>
            <tr>
                <td>员工姓名：</td>
                <td class="last2"><input name="sName" type="text" style="width:345px;" value="${sf.sName }"/></td>
            </tr>
            <tr>
            ...
            <tr>
                <td>身份证号：</td>
                <td class="last2"><input name="sIdentityId" type="text" value="${sf.sIdentityId }" maxlength="18"
                ...
                <td class="last2" align="left">
                    <select name="sPost" id="sPost" style="width:350px;" onchange="gongzi()">
                        <c:forEach items="${post}" var="pt">
                            <option value="<c:out value="${pt.pId }"></c:out>"><c:out
                                    value="${pt.pName }"></c:out></option>
                        </c:forEach>
                    </select>
                    &nbsp;对应职位薪水：
                 <input name="sSalary" type="text"/>&nbsp;元人民币（月薪）
                </td>
            </tr>
            <tr>
                <td>入职时间：</td>
