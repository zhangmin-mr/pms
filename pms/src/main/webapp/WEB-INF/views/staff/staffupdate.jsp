...
<form name="form1" method="post" action="<%=path %>/servlet/updateStaff" >
 ...
 <tr><td style="width:20%;">性别：</td><td class="last2" align="left">
 <select name="sSex"  style="width:350px;" >
  <option value="男" selected="selected">男</option>
  <option value="女">女</option>
  </select>
 </td></tr>
 <tr><td>出生年月：</td><td class="last2">
 ...
 <tr><td>身份证号：</td><td class="last2"><input name="sIdentityId" type="text" value="${sf.sIdentityId }" maxlength="18" style="width:345px;"/></td></tr>
 <tr><td style="width:20%;">职位名称：</td><td  class="last2" align="left">
  ...
  <c:forEach items="${post}" var="pt"> 
  <option value="<c:out value="${pt.pSalary }"></c:out>"><c:out value="${pt.pSalary }"></c:out></option>
  </c:forEach>
  </select>&nbsp;元人民币（月薪）
  </td>
  </tr>  
  <tr><td>入职时间：</td><td class="last2">
