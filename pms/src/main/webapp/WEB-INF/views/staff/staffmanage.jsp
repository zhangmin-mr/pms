...
<form name="form1" method="post" action="<%=path %>/servlet/manageStaff">
 ...
 <td>出生年月</td><td>身份证号</td><td>职位</td><td>部门</td><td>薪水</td><td>入职时间</td><td class="last">管理操作</td>
 </tr>
 ...
 <td ><fmt:parseDate value="${staff.sEntry}" var="date" pattern="yyyy-MM-dd"></fmt:parseDate><fmt:formatDate value="${date }"/></td>
  <td width="100px">
  <div class="btn2"><a href="<%=path %>/servlet/gotoUpdatestaff?sId=<c:out value="${staff.sId}"></c:out>">更改</a></div> 
